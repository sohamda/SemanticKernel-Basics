...
public interface Constants {
    ...
    String TextToSummarize = """
            Semantic Kernel for Java is an open source library that empowers developers to harness the power of AI while coding in Java. 
            It is compatible with Java 8 and above, ensuring flexibility and accessibility to a wide range of Java developers. 
            By integrating AI services into your Java applications, you can unlock the full potential of artificial intelligence 
            and large language models without sacrificing the familiar Java development environment.
            """;
    ...
    static Map<String, String> data() {
        return Map.of(
                "https://learn.microsoft.com/en-us/semantic-kernel/overview/", "Semantic Kernel or SK Overview: How does it work, basics, terminologies, why do we need Semantic Kernel.",
                "https://learn.microsoft.com/en-us/semantic-kernel/get-started/tutorials", "In depth tutorial with C#: step by step tutorial to create and enrich LLM interactions.",
                "https://learn.microsoft.com/en-us/semantic-kernel/ai-orchestration/?tabs=Csharp", "AI Plugins: What is a plugin, how to use them, when to use them",
                "https://learn.microsoft.com/en-us/semantic-kernel/prompt-engineering/", "Prompt Engineering: What is it and how to use properly prompting when working with LLMs",
                "https://learn.microsoft.com/en-us/semantic-kernel/memories/", "Memories, Embedding : how to give LLM a memory to use in combination with the knowledge it has."
        );
    }
}
